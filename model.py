...
print(f"Model Accuracy for press times with knnn: {accuracy_score(press_label_test, press_predictions_knn) * 100:.2f}%")
print(f"Model Accuracy for wait times with knn: {accuracy_score(wait_label_test, wait_predictions_knn) * 100:.2f}%")

# TODO: make comparison of knn vs decisiontree ---------------------------------------------------------------
